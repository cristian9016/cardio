...
import Adapters.CapitulosAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            caps.add("Capitulo 1");caps.add("Capitulo 2");caps.add("Capitulo 3");caps.add("Capitulo 4");
            caps.add("Capitulo 5");caps.add("Capitulo 6");caps.add("Capitulo 7");caps.add("Capitulo 8");
            ...
            switch (getArguments().getInt(ARG_SECTION_NUMBER)){
                ...
                case 2:
                    ...
                    ListView lv1 = (ListView) rootView.findViewById(R.id.listCapitulos);
                    CapitulosAdapter capsAdapter = new CapitulosAdapter(getContext(),caps);
                    lv1.setAdapter(capsAdapter);
                    break;
                case 3:
